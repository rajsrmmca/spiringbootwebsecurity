package com.raj.userservice.api;
...
public class UserResource {
    ...
    @PostMapping("/role/addRolesToUser")
    public ResponseEntity<?> addRolesToUser(@RequestBody RolesToUserForm form){
        userService.addRolesToUser(form.getUserName(), form.getRoleNames());
        return ResponseEntity.ok().build();
    }
    ...
    @PostMapping("/login")
    public void login(@RequestBody APICredentials apiCredentials) {
